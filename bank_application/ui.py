...
from database import CompleteDatabase
...
class MainWindow:
    ...
    def __init__(self, database: CompleteDatabase):
    ...
    def edit_card(self, event=None) -> None:
        """Edit selected card"""
    ...
    def copy_card_details(self) -> None:
...
class AddCardDialog:
    ...
    def __init__(self, parent: tk.Tk | tk.Toplevel, database: CompleteDatabase, callback: callable):
        self.parent = parent
        self.database = database
    ...
    def format_atm_number(self, event=None) -> None:
    ...
    def format_account_number(self, event=None) -> None:
...
class EditCardDialog:
    ...
    def __init__(self, parent: tk.Tk | tk.Toplevel, database: CompleteDatabase, card: dict, callback: callable):
        self.parent = parent
        self.database = database
        self.card = card
        self.callback = callback
